...
// This class is created for the example scene. There is no support for this
// script.
public class HintManagement : MonoBehaviour {
  ...
  private void OnTriggerStay(Collider other) {
    if (message2 != "" && other.gameObject == player &&
        Input.GetKeyDown(changeMessageKey)) {
