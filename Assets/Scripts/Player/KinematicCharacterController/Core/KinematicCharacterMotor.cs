...
/// <summary>
/// Represents the entire state of a character motor that is pertinent for
/// simulation. Use this to save state or revert to past state
/// </summary>
[System.Serializable]
...
public struct CharacterGroundingReport {
  ...
  public void
  CopyFrom(CharacterTransientGroundingReport transientGroundingReport) {
...
/// <summary>
/// Contains the simulation-relevant information for the motor's grounding
/// status
/// </summary>
...
/// <summary>
/// Contains the information of hit rigidbodies during the movement phase, so
...
#pragma warning restore 0649
  ...
  /// <summary>
  /// Increases the range of ground detection, to allow snapping to ground at
  /// very high speeds
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Handles properly detecting grounding status on steps, but has a
  /// performance cost.
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Minimum length of a step that the character can step on (used in Extra
  /// stepping method. Use this to let the character step on steps that are
  ...
  /// <summary>
  /// Handles properly detecting ledge information and grounding status, but has
  /// a performance cost.
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// The distance from the capsule central axis at which the character can
  /// stand on a ledge and still be stable
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// The maximun downward slope angle change that the character can be
  /// subjected to and still be snapping to the ground
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Handles properly being pushed by and standing on PhysicsMovers or dynamic
  /// rigidbodies. Also handles pushing dynamic rigidbodies
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// How the character interacts with non-kinematic rigidbodies. \"Kinematic\"
  /// mode means the character pushes the rigidbodies with infinite force (as a
  /// kinematic body would). \"SimulatedDynamic\" pushes the rigidbodies with a
  ...
  /// <summary>
  /// Determines if the character preserves moving platform velocities when
  /// de-grounding from them
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Defines the plane that the character's movement is constrained on, if
  /// HasMovementConstraintPlane is active
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Checks for overlaps before casting movement, making sure all collisions
  /// are detected even when already intersecting geometry (has a performance
  ...
  public CharacterGroundingReport GroundingStatus =
      new CharacterGroundingReport();
  /// <summary>
  /// Contains the previous grounding information
  /// </summary>
  [System.NonSerialized]
  public CharacterTransientGroundingReport LastGroundingStatus =
      new CharacterTransientGroundingReport();
  /// <summary>
  /// Specifies the LayerMask that the character's movement algorithm can detect
  /// collisions with. By default, this uses the rigidbody's layer's collision
  /// matrix
  /// </summary>
  [System.NonSerialized]
  ...
  /// <summary>
  /// The character's goal position in its movement calculations (always
  /// up-to-date during the character update phase)
  /// </summary>
  ...
  /// <summary>
  /// The character's up direction (always up-to-date during the character
  /// update phase)
  /// </summary>
  ...
  /// <summary>
  /// The character's forward direction (always up-to-date during the character
  /// update phase)
  /// </summary>
  ...
  /// <summary>
  /// The character's right direction (always up-to-date during the character
  /// update phase)
  /// </summary>
  ...
  /// <summary>
  /// Vector3 from the character transform position to the capsule bottom hemi
  /// center
  /// </summary>
  ...
  /// <summary>
  /// Vector3 from the character transform position to the capsule top hemi
  /// center
  /// </summary>
  ...
  /// <summary>
  /// The character's velocity resulting from standing on rigidbodies or
  /// PhysicsMover
  /// </summary>
  public Vector3 AttachedRigidbodyVelocity {
  ...
  private OverlapResult[] _overlaps =
      new OverlapResult[MaxRigidbodyOverlapsCount];
  ...
  private Collider[] _internalProbedColliders =
      new Collider[MaxCollisionBudget];
  ...
  /// <summary>
  /// The character's goal rotation in its movement calculations (always
  /// up-to-date during the character update phase)
  /// </summary>
  ...
  /// <summary>
  /// The character's total velocity, including velocity from standing on
  /// rigidbodies or PhysicsMover
  /// </summary>
  public Vector3 Velocity {
    get { return BaseVelocity + _attachedRigidbodyVelocity; }
  }

  // Warning: Don't touch these constants unless you know exactly what you're
  // doing!
...
#pragma warning restore 0414
  ...
  private void Reset() { ValidateData(); }
  ...
  public void ValidateData() {
    ...
    MaxStableDistanceFromLedge =
        Mathf.Clamp(MaxStableDistanceFromLedge, 0f, CapsuleRadius);
  ...
  /// <summary>
  /// Sets whether or not the motor will solve collisions when moving (or moved
  /// onto)
  /// </summary>
  public void
  SetMovementCollisionsSolvingActivation(bool movementCollisionsSolvingActive) {
  ...
  /// <summary>
  /// Moves the character position, taking all movement collision solving int
  /// account. The actual move is done the next time the motor updates are
  /// called
  /// </summary>
  ...
  /// <summary>
  /// Moves the character rotation. The actual move is done the next time the
  /// motor updates are called
  /// </summary>
  ...
  /// <summary>
  /// Returns all the state information of the motor that is pertinent for
  /// simulation
  /// </summary>
  public KinematicCharacterMotorState GetState() {
    ...
    state.LastMovementIterationFoundAnyGround =
  ...
  public void SetCapsuleDimensions(float radius, float height, float yOffset) {
    height = Mathf.Max(
        height,
        (radius * 2f) + 0.01f); // Safety to prevent invalid capsule geometries
    ...
    Capsule.height =
        Mathf.Clamp(CapsuleHeight, CapsuleRadius * 2f, CapsuleHeight);
  ...
  /// <summary>
  /// Update phase 1 is meant to be called after physics movers have calculated
  /// their velocities, but before they have simulated their goal
  /// positions/rotations. It is responsible for:
  ...
  public void UpdatePhase1(float deltaTime) {
    ...
    if (float.IsNaN(BaseVelocity.x) || float.IsNaN(BaseVelocity.y) ||
...
#region Handle Move Position
    if (_movePositionDirty) {
      if (_solveMovementCollisions) {
        Vector3 tmpVelocity = GetVelocityFromMovement(
            _movePositionTarget - _transientPosition, deltaTime);
...
#region Resolve initial overlaps
      ...
      while (iterationsMade < MaxDecollisionIterations && !overlapSolved) {
        int nbOverlaps = CharacterCollisionsOverlap(
            _transientPosition, _transientRotation, _internalProbedColliders);

        if (nbOverlaps > 0) {
          // Solve overlaps that aren't against dynamic rigidbodies or physics
          // movers
          for (int i = 0; i < nbOverlaps; i++) {
            if (GetInteractiveRigidbody(_internalProbedColliders[i]) == null) {
              ...
              if (Physics.ComputePenetration(
                      Capsule, _transientPosition, _transientRotation,
                      _internalProbedColliders[i], overlappedTransform.position,
                      overlappedTransform.rotation, out resolutionDirection,
                ...
                resolutionDirection = GetObstructionNormal(resolutionDirection,
                                                           mockReport.IsStable);
                ...
                if (_overlapsCount < _overlaps.Length) {
                  _overlaps[_overlapsCount] = new OverlapResult(
                      resolutionDirection, _internalProbedColliders[i]);
                  _overlapsCount++;
                }
...
#region Ground Probing and Snapping
    ...
    if (_solveGrounding) {
      if (MustUnground()) {
        _transientPosition +=
            _characterUp * (MinimumGroundProbingDistance * 1.5f);
      } else {
        ...
        if (!LastGroundingStatus.SnappingPrevented &&
          ...
          if (StepHandling != StepHandlingMethod.None) {
            selectedGroundProbingDistance =
                Mathf.Max(CapsuleRadius, MaxStepHeight);
          } else {
        ...
        ProbeGround(ref _transientPosition, _transientRotation,
                    selectedGroundProbingDistance, ref GroundingStatus);

        if (!LastGroundingStatus.IsStableOnGround &&
            GroundingStatus.IsStableOnGround) {
          // Handle stable landing
          BaseVelocity = Vector3.ProjectOnPlane(BaseVelocity, CharacterUp);
          BaseVelocity = GetDirectionTangentToSurface(
                             BaseVelocity, GroundingStatus.GroundNormal) *
...
#region Interactive Rigidbody Handling
      ...
      if (AttachedRigidbodyOverride) {
        ...
        if (GroundingStatus.IsStableOnGround &&
          ...
          Rigidbody interactiveRigidbody =
              GetInteractiveRigidbody(GroundingStatus.GroundCollider);
      ...
      if (_attachedRigidbody) {
        GetVelocityFromRigidbodyMovement(
            _attachedRigidbody, _transientPosition, deltaTime,
        ...
        Vector3 newForward =
            Vector3
                .ProjectOnPlane(
                    Quaternion.Euler(
                        Mathf.Rad2Deg *
                        tmpAngularVelocityFromCurrentAttachedRigidbody *
                        deltaTime) *
                        _characterForward,
                    _characterUp)
                .normalized;
      ...
      if (GroundingStatus.GroundCollider &&
        ...
        BaseVelocity -=
            Vector3.ProjectOnPlane(_attachedRigidbodyVelocity, _characterUp);
      }
  ...
  /// <summary>
  /// Update phase 2 is meant to be called after physics movers have simulated
  /// their goal positions/rotations. At the end of this, the
  /// TransientPosition/Rotation values will be up-to-date with where the motor
  /// should be at the end of its move. It is responsible for:
  /// - Solving Rotation
...
#region Solve potential attached rigidbody overlap
        if (_attachedRigidbody) {
          ...
          if (CharacterGroundSweep(_transientPosition +
                                       (_characterUp * upwardsOffset),
                                   _transientRotation, -_characterUp,
                                   upwardsOffset, out closestHit)) {
            if (closestHit.collider.attachedRigidbody == _attachedRigidbody &&
              ...
              _transientPosition = _transientPosition +
                                   (_characterUp * distanceMovedUp) +
          ...
          if (nbOverlaps > 0) {
            for (int i = 0; i < nbOverlaps; i++) {
              ...
              if (Physics.ComputePenetration(
                ...
                // If interactiveRigidbody, register as rigidbody hit for
                // velocity
                if (InteractiveRigidbodyHandling) {
                  ...
                  if (probedRigidbody != null) {
                    ...
                    if (probedRigidbody != _attachedRigidbody) {
                      ...
                      StoreRigidbodyHit(probedRigidbody, Velocity,
...
#region Calculate Character movement from base velocity
    ...
    if (DiscreteCollisionEvents) {
      int nbOverlaps = CharacterCollisionsOverlap(
          ...
          CollisionOffset * 2f);
      for (int i = 0; i < nbOverlaps; i++) {
        CharacterController.OnDiscreteCollisionDetected(
    ...
    if (LedgeAndDenivelationHandling) {
      if (stabilityReport.LedgeDetected) {
        if (stabilityReport.IsMovingTowardsEmptySideOfLedge) {
          // Max snap vel
          Vector3 velocityOnLedgeNormal =
              Vector3.Project(velocity, stabilityReport.LedgeFacingDirection);
      ...
      if (LastGroundingStatus.FoundAnyGround &&
        ...
        float denivelationAngle = Vector3.Angle(stabilityReport.InnerNormal,
                                                stabilityReport.OuterNormal);
        if (denivelationAngle > MaxStableDenivelationAngle) {
          return false;
        } else {
          denivelationAngle =
              Vector3.Angle(LastGroundingStatus.InnerGroundNormal,
                            stabilityReport.OuterNormal);
          if (denivelationAngle > MaxStableDenivelationAngle) {
            return false;
          }
  ...
  /// <summary>
  /// Probes for valid ground and midifies the input transientPosition if ground
  /// snapping occurs
  /// </summary>
  public void ProbeGround(ref Vector3 probingPosition, Quaternion atRotation,
    ...
    while (groundProbeDistanceRemaining > 0 &&
      ...
      if (CharacterGroundSweep(groundSweepPosition,          // position
                               atRotation,                   // rotation
                               ...
                               out groundSweepHit))          // hit
      {
        ...
        EvaluateHitStability(groundSweepHit.collider, groundSweepHit.normal,
                             groundSweepHit.point, targetPosition,
                             _transientRotation, BaseVelocity,
        ...
        groundingReport.InnerGroundNormal =
            groundHitStabilityReport.InnerNormal;
        groundingReport.OuterGroundNormal =
            groundHitStabilityReport.OuterNormal;
        ...
        if (groundHitStabilityReport.IsStable) {
          ...
          groundingReport.SnappingPrevented = !IsStableWithSpecialCases(
              ref groundHitStabilityReport, BaseVelocity);
          ...
          if (!groundingReport.SnappingPrevented) {
            probingPosition = groundSweepPosition +
                              (groundSweepDirection *
                               (groundSweepHit.distance - CollisionOffset));
          }

          CharacterController.OnGroundHit(
              groundSweepHit.collider, groundSweepHit.normal,
          ...
          Vector3 sweepMovement =
              (groundSweepDirection * groundSweepHit.distance) +
              ((atRotation * _cachedWorldUp) *
               Mathf.Max(CollisionOffset, groundSweepHit.distance));
          ...
          groundProbeDistanceRemaining = Mathf.Min(
              ...
              Mathf.Max(groundProbeDistanceRemaining - sweepMovement.magnitude,
                        0f));

          // Reorient direction
          groundSweepDirection =
              Vector3
                  .ProjectOnPlane(groundSweepDirection, groundSweepHit.normal)
                  .normalized;
        }
      } else {
        groundSweepingIsOver = true;
  ...
  /// <summary>
  /// Returns the direction adjusted to be tangent to a specified surface normal
  /// relatively to the character's up direction. Useful for reorienting a
  /// direction on a slope without any lateral deviation in trajectory
  /// </summary>
  public Vector3 GetDirectionTangentToSurface(Vector3 direction,
  ...
  /// <summary>
  /// Moves the character's position by given movement while taking into account
  /// all physics simulation, step-handling and velocity projection rules that
  /// affect the character motor
  /// </summary>
  /// <returns> Returns false if movement could not be solved until the end
  /// </returns>
  private bool InternalCharacterMove(ref Vector3 transientVelocity,
                                     float deltaTime) {
    if (deltaTime <= 0f)
      return false;
    ...
    // Planar constraint
    if (HasPlanarConstraint) {
      transientVelocity = Vector3.ProjectOnPlane(
          transientVelocity, PlanarConstraintAxis.normalized);
    }
    ...
    for (int i = 0; i < _overlapsCount; i++) {
      ...
      if (Vector3.Dot(remainingMovementDirection, overlapNormal) < 0f) {
        ...
        InternalHandleVelocityProjection(
            stableOnHit, overlapNormal, obstructionNormal,
            originalVelocityDirection, ref sweepState, previousHitIsStable,
            previousVelocity, previousObstructionNormal, ref transientVelocity,
    ...
    while (remainingMovementMagnitude > 0f &&
      ...
      if (CheckMovementInitialOverlaps) {
        int numOverlaps =
            CharacterCollisionsOverlap(tmpMovedPosition, _transientRotation,
                                       _internalProbedColliders, 0f, false);
        if (numOverlaps > 0) {
          ...
          for (int i = 0; i < numOverlaps; i++) {
            ...
            if (Physics.ComputePenetration(Capsule, tmpMovedPosition,
                                           _transientRotation, tmpCollider,
                                           tmpCollider.transform.position,
                                           tmpCollider.transform.rotation,
                                           out Vector3 resolutionDirection,
                                           out float resolutionDistance)) {
              float dotProduct =
                  Vector3.Dot(remainingMovementDirection, resolutionDirection);
              if (dotProduct < 0f &&
                  dotProduct < mostObstructingOverlapNormalDotProduct) {
      ...
      if (foundClosestHit) {
        ...
        EvaluateHitStability(closestSweepHitCollider, closestSweepHitNormal,
                             closestSweepHitPoint, tmpMovedPosition,
                             _transientRotation, transientVelocity,
        ...
        if (_solveGrounding && StepHandling != StepHandlingMethod.None &&
          ...
          float obstructionCorrelation =
              Mathf.Abs(Vector3.Dot(closestSweepHitNormal, _characterUp));
          if (obstructionCorrelation <= CorrelationForVerticalObstruction) {
            Vector3 stepForwardDirection =
                Vector3.ProjectOnPlane(-closestSweepHitNormal, _characterUp)
                    .normalized;
            ...
            int nbStepHits = CharacterCollisionsSweep(
                ...
                _internalCharacterHits, 0f,
                true); // all hits

            // Check for hit corresponding to stepped collider
            for (int i = 0; i < nbStepHits; i++) {
              if (_internalCharacterHits[i].collider ==
                  moveHitStabilityReport.SteppedCollider) {
                ...
                transientVelocity =
                    Vector3.ProjectOnPlane(transientVelocity, CharacterUp);
        ...
        if (!foundValidStepHit) {
          Vector3 obstructionNormal = GetObstructionNormal(
              closestSweepHitNormal, moveHitStabilityReport.IsStable);

          // Movement hit callback
          CharacterController.OnMovementHit(
              closestSweepHitCollider, closestSweepHitNormal,
          ...
          if (InteractiveRigidbodyHandling &&
            ...
            StoreRigidbodyHit(closestSweepHitCollider.attachedRigidbody,
                              transientVelocity, closestSweepHitPoint,
                              obstructionNormal, moveHitStabilityReport);
          }
          ...
          InternalHandleVelocityProjection(
              stableOnHit, closestSweepHitNormal, obstructionNormal,
              originalVelocityDirection, ref sweepState, previousHitIsStable,
              previousVelocity, previousObstructionNormal,
              ref transientVelocity, ref remainingMovementMagnitude,
    ...
    tmpMovedPosition +=
        (remainingMovementDirection * remainingMovementMagnitude);
  ...
  /// <summary>
  /// Gets the effective normal for movement obstruction depending on current
  /// grounding status
  /// </summary>
    ...
    if (GroundingStatus.IsStableOnGround && !MustUnground() && !stableOnHit) {
      Vector3 obstructionLeftAlongGround =
          Vector3.Cross(GroundingStatus.GroundNormal, obstructionNormal)
              .normalized;
      obstructionNormal =
          Vector3.Cross(obstructionLeftAlongGround, _characterUp).normalized;
    }
  ...
  /// </summary>
  private void StoreRigidbodyHit(Rigidbody hitRigidbody, Vector3 hitVelocity,
                                 Vector3 hitPoint, Vector3 obstructionNormal,
                                 HitStabilityReport hitStabilityReport) {
    if (_rigidbodyProjectionHitCount <
        _internalRigidbodyProjectionHits.Length) {
  ...
  /// </summary>
  private void InternalHandleVelocityProjection(
      bool stableOnHit, Vector3 hitNormal, Vector3 obstructionNormal,
      Vector3 originalDirection, ref MovementSweepState sweepState,
      bool previousHitIsStable, Vector3 previousVelocity,
      Vector3 previousObstructionNormal, ref Vector3 transientVelocity,
    ...
    if (stableOnHit) {
      ...
      HandleVelocityProjection(ref transientVelocity, obstructionNormal,
                               stableOnHit);
    } else {
      // Handle projection
      ...
      // Blocking crease handling
        ...
        EvaluateCrease(transientVelocity, previousVelocity, obstructionNormal,
                       previousObstructionNormal, stableOnHit,
                       previousHitIsStable,
        ...
        if (foundCrease) {
          if (GroundingStatus.IsStableOnGround && !MustUnground()) {
            ...
            transientVelocity =
                Vector3.Project(transientVelocity, creaseDirection);
    ...
    float newVelocityFactor =
        transientVelocity.magnitude / velocityBeforeProjection.magnitude;
    remainingMovementMagnitude *= newVelocityFactor;
    remainingMovementDirection = transientVelocity.normalized;
  }

  private void EvaluateCrease(Vector3 currentCharacterVelocity,
                              Vector3 previousCharacterVelocity,
                              Vector3 currentHitNormal,
                              Vector3 previousHitNormal,
                              bool currentHitIsStable, bool previousHitIsStable,
                              bool characterIsStable, out bool isValidCrease,
                              out Vector3 creaseDirection) {
    isValidCrease = false;
    creaseDirection = default;

    if (!characterIsStable || !currentHitIsStable || !previousHitIsStable) {
      Vector3 tmpBlockingCreaseDirection =
          Vector3.Cross(currentHitNormal, previousHitNormal).normalized;
      ...
      if (dotPlanes < 0.999f) {
        ...
        Vector3 normalAOnCreasePlane =
            Vector3.ProjectOnPlane(currentHitNormal, tmpBlockingCreaseDirection)
                .normalized;
        Vector3 normalBOnCreasePlane =
            Vector3
                .ProjectOnPlane(previousHitNormal, tmpBlockingCreaseDirection)
                .normalized;
        float dotPlanesOnCreasePlane =
            Vector3.Dot(normalAOnCreasePlane, normalBOnCreasePlane);

        Vector3 enteringVelocityDirectionOnCreasePlane =
            Vector3
                .ProjectOnPlane(previousCharacterVelocity,
                                tmpBlockingCreaseDirection)
                .normalized;

        if (dotPlanesOnCreasePlane <=
                (Vector3.Dot(-enteringVelocityDirectionOnCreasePlane,
                             normalAOnCreasePlane) +
                 0.001f) &&
      ...
      if (isVelocityConstrainedByCrease) {
        // Flip crease direction to make it representative of the real direction
        // our velocity would be projected to
        if (Vector3.Dot(tmpBlockingCreaseDirection, currentCharacterVelocity) <
            0f) {
  ...
  public virtual void HandleVelocityProjection(ref Vector3 velocity,
    ...
    if (GroundingStatus.IsStableOnGround && !MustUnground()) {
      ...
      // On blocking hits, project the movement on the obstruction while
      // following the grounding plane
      else {
        Vector3 obstructionRightAlongGround =
            Vector3.Cross(obstructionNormal, GroundingStatus.GroundNormal)
                .normalized;
        Vector3 obstructionUpAlongGround =
            Vector3.Cross(obstructionRightAlongGround, obstructionNormal)
                .normalized;
        velocity =
            GetDirectionTangentToSurface(velocity, obstructionUpAlongGround) *
            velocity.magnitude;
  ...
  /// <summary>
  /// Allows you to override the way hit rigidbodies are pushed / interacted
  /// with. ProcessedVelocity is what must be modified if this interaction
  /// affects the character's velocity.
  /// </summary>
  public virtual void
  HandleSimulatedRigidbodyInteraction(ref Vector3 processedVelocity,
  ...
  private void ProcessVelocityForRigidbodyHits(ref Vector3 processedVelocity,
    ...
    for (int i = 0; i < _rigidbodyProjectionHitCount; i++) {
      ...
      if (bodyHit.Rigidbody &&
          !_rigidbodiesPushedThisMove.Contains(bodyHit.Rigidbody)) {
        if (_internalRigidbodyProjectionHits[i].Rigidbody !=
          ...
          float characterToBodyMassRatio = 1f;
          {
            ...
            else if (RigidbodyInteractionType ==
          ...
          ComputeCollisionResolutionForHitBody(
              bodyHit.EffectiveHitNormal, characterVelocity, hitBodyVelocity,
              characterToBodyMassRatio, out Vector3 velocityChangeOnCharacter,
          ...
          if (hitBodyIsCharacter) {
            ...
            bodyHit.Rigidbody.AddForceAtPosition(velocityChangeOnBody,
                                                 bodyHit.HitPoint,
                                                 ForceMode.VelocityChange);
          }

          if (RigidbodyInteractionType ==
  ...
  public void ComputeCollisionResolutionForHitBody(
      Vector3 hitNormal, Vector3 characterVelocity, Vector3 bodyVelocity,
      float characterToBodyMassRatio, out Vector3 velocityChangeOnCharacter,
      out Vector3 velocityChangeOnBody) {
    velocityChangeOnCharacter = default;
    velocityChangeOnBody = default;

    float bodyToCharacterMassRatio = 1f - characterToBodyMassRatio;
    float characterVelocityMagnitudeOnHitNormal =
        Vector3.Dot(characterVelocity, hitNormal);
    float bodyVelocityMagnitudeOnHitNormal =
        Vector3.Dot(bodyVelocity, hitNormal);

    // if character velocity was going against the obstruction, restore the
    // portion of the velocity that got projected during the movement phase
    if (characterVelocityMagnitudeOnHitNormal < 0f) {
      Vector3 restoredCharacterVelocity =
          hitNormal * characterVelocityMagnitudeOnHitNormal;
      velocityChangeOnCharacter += restoredCharacterVelocity;
    }

    // solve impulse velocities on both bodies, but only if the body velocity
    // would be giving resistance to the character in any way
    if (bodyVelocityMagnitudeOnHitNormal >
        characterVelocityMagnitudeOnHitNormal) {
      Vector3 relativeImpactVelocity =
          hitNormal * (bodyVelocityMagnitudeOnHitNormal -
                       characterVelocityMagnitudeOnHitNormal);
      velocityChangeOnCharacter +=
          relativeImpactVelocity * bodyToCharacterMassRatio;
      velocityChangeOnBody +=
          -relativeImpactVelocity * characterToBodyMassRatio;
    }
  }
  ...
  private bool InternalIsColliderValidForCollisions(Collider coll) {
    ...
    if (colliderAttachedRigidbody) {
      ...
      // If movement is made from AttachedRigidbody, ignore the
      // AttachedRigidbody
      ...
      // don't collide with dynamic rigidbodies if our RigidbodyInteractionType
      // is kinematic
  ...
  public void EvaluateHitStability(Collider hitCollider, Vector3 hitNormal,
    ...
    Vector3 innerHitDirection =
        Vector3.ProjectOnPlane(hitNormal, atCharacterUp).normalized;
    ...
    if (LedgeAndDenivelationHandling) {
      ...
      if (CharacterCollisionsRaycast(
              ...
              -atCharacterUp, ledgeCheckHeight + SecondaryProbesVertical,
      ...
      stabilityReport.LedgeDetected =
          (isStableLedgeInner != isStableLedgeOuter);
      if (stabilityReport.LedgeDetected) {
        stabilityReport.IsOnEmptySideOfLedge =
            isStableLedgeOuter && !isStableLedgeInner;
        stabilityReport.LedgeGroundNormal = isStableLedgeOuter
                                                ? stabilityReport.OuterNormal
                                                : stabilityReport.InnerNormal;
        stabilityReport.LedgeRightDirection =
            Vector3.Cross(hitNormal, stabilityReport.LedgeGroundNormal)
                .normalized;
        stabilityReport.LedgeFacingDirection =
            Vector3
                .ProjectOnPlane(
                    Vector3.Cross(stabilityReport.LedgeGroundNormal,
                                  stabilityReport.LedgeRightDirection),
                    CharacterUp)
                .normalized;
        ...
        stabilityReport.IsMovingTowardsEmptySideOfLedge =
            Vector3.Dot(withCharacterVelocity.normalized,
                        stabilityReport.LedgeFacingDirection) > 0f;
      }

      if (stabilityReport.IsStable) {
        stabilityReport.IsStable = IsStableWithSpecialCases(
            ref stabilityReport, withCharacterVelocity);
      }
    }
    ...
    if (StepHandling != StepHandlingMethod.None && !stabilityReport.IsStable) {
      ...
      if (!(hitRigidbody && !hitRigidbody.isKinematic)) {
        DetectSteps(atCharacterPosition, atCharacterRotation, hitPoint,
                    innerHitDirection, ref stabilityReport);
    ...
    CharacterController.ProcessHitStabilityReport(
        hitCollider, hitNormal, hitPoint, atCharacterPosition,
        atCharacterRotation, ref stabilityReport);
  }

  private void DetectSteps(Vector3 characterPosition,
                           Quaternion characterRotation, Vector3 hitPoint,
                           Vector3 innerHitDirection,
                           ref HitStabilityReport stabilityReport) {
    int nbStepHits = 0;
    ...
    Vector3 verticalCharToHit =
        Vector3.Project((hitPoint - characterPosition), characterUp);
    Vector3 horizontalCharToHitDirection =
        Vector3.ProjectOnPlane((hitPoint - characterPosition), characterUp)
            .normalized;
    Vector3 stepCheckStartPos =
        (hitPoint - verticalCharToHit) + (characterUp * MaxStepHeight) +
    ...
    nbStepHits = CharacterCollisionsSweep(
        stepCheckStartPos, characterRotation, -characterUp,
        MaxStepHeight + CollisionOffset, out outerStepHit,
        _internalCharacterHits, 0f, true);
  ...
  private bool CheckStepValidity(int nbStepHits, Vector3 characterPosition,
    ...
    while (nbStepHits > 0 && !foundValidStepPosition) {
      ...
      Vector3 characterPositionAtHit =
          stepCheckStartPos +
          (-characterUp * (farthestHit.distance - CollisionOffset));

      int atStepOverlaps = CharacterCollisionsOverlap(
          characterPositionAtHit, characterRotation, _internalProbedColliders);
      if (atStepOverlaps <= 0) {
        ...
        if (CharacterCollisionsRaycast(
                ...
                out RaycastHit outerSlopeHit, _internalCharacterHits,
                true) > 0) {
            ...
            if (CharacterCollisionsSweep(
              ...
              if (AllowSteppingWithoutStableGrounding) {
                ...
                if (CharacterCollisionsRaycast(
                        characterPosition +
                            Vector3.Project(
                                (characterPositionAtHit - characterPosition),
                                characterUp),
                        -characterUp, MaxStepHeight, out innerStepHit,
      ...
      if (!foundValidStepPosition) {
        ...
        if (farthestIndex < nbStepHits) {
          _internalCharacterHits[farthestIndex] =
  ...
  /// <summary>
  /// Get true linear velocity (taking into account rotational velocity) on a
  /// given point of a rigidbody
  /// </summary>
  public void GetVelocityFromRigidbodyMovement(Rigidbody interactiveRigidbody,
                                               Vector3 atPoint, float deltaTime,
    ...
    if (deltaTime > 0f) {
      ...
      if (interactiveRigidbody.isKinematic) {
        PhysicsMover physicsMover =
            interactiveRigidbody.GetComponent<PhysicsMover>();
        if (physicsMover) {
      ...
      if (angularVelocity != Vector3.zero) {
        Vector3 centerOfRotation =
            interactiveRigidbody.transform.TransformPoint(
                interactiveRigidbody.centerOfMass);
        ...
        Vector3 finalPointPosition =
            centerOfRotation +
            (rotationFromInteractiveRigidbody * centerOfRotationToPoint);
  ...
  /// <summary>
  /// Calculates the velocity required to move the character to the target
  /// position over a specific deltaTime. Useful for when you wish to work with
  /// positions rather than velocities in the UpdateVelocity callback
  /// </summary>
  public Vector3 GetVelocityForMovePosition(Vector3 fromPosition,
                                            Vector3 toPosition,
                                            float deltaTime) {
  ...
  public int
  CharacterCollisionsOverlap(Vector3 position, Quaternion rotation,
                             Collider[] overlappedColliders, float inflate = 0f,
    ...
    int nbUnfilteredHits = Physics.OverlapCapsuleNonAlloc(
        bottom, top, Capsule.radius + inflate, overlappedColliders, queryLayers,
  ...
  /// </summary>
  /// <returns> Returns number of overlaps </returns>
  public int CharacterOverlap(Vector3 position, Quaternion rotation,
                              Collider[] overlappedColliders, LayerMask layers,
    ...
    int nbHits = 0;
    int nbUnfilteredHits = Physics.OverlapCapsuleNonAlloc(
        bottom, top, Capsule.radius + inflate, overlappedColliders, layers,
        triggerInteraction);
  ...
  public int CharacterCollisionsSweep(
      Vector3 position, Quaternion rotation, Vector3 direction, float distance,
      out RaycastHit closestHit, RaycastHit[] hits, float inflate = 0f,
      bool acceptOnlyStableGroundLayer = false) {
    int queryLayers = CollidableLayers;
    if (acceptOnlyStableGroundLayer) {
      queryLayers = CollidableLayers & StableGroundLayers;
    ...
    Vector3 bottom = position +
                     (rotation * _characterTransformToCapsuleBottomHemi) -
    ...
    int nbUnfilteredHits = Physics.CapsuleCastNonAlloc(
        bottom, top, Capsule.radius + inflate, direction, hits,
        distance + SweepProbingBackstepDistance, queryLayers,
        QueryTriggerInteraction.Ignore);
  ...
  /// </summary>
  /// <returns> Returns the number of hits </returns>
  public int CharacterSweep(Vector3 position, Quaternion rotation,
                            Vector3 direction, float distance,
                            out RaycastHit closestHit, RaycastHit[] hits,
                            LayerMask layers,
                            QueryTriggerInteraction triggerInteraction,
                            float inflate = 0f) {
    closestHit = new RaycastHit();
    ...
    int nbHits = 0;
    int nbUnfilteredHits = Physics.CapsuleCastNonAlloc(
        bottom, top, Capsule.radius + inflate, direction, hits, distance,
        layers, triggerInteraction);
  ...
  /// <summary>
  /// Casts the character volume in the character's downward direction to detect
  /// ground
  /// </summary>
  /// <returns> Returns the number of hits </returns>
  private bool CharacterGroundSweep(Vector3 position, Quaternion rotation,
                                    Vector3 direction, float distance,
    ...
    int nbUnfilteredHits = Physics.CapsuleCastNonAlloc(
        ...
        position + (rotation * _characterTransformToCapsuleTopHemi) -
            (direction * GroundProbingBackstepDistance),
        Capsule.radius, direction, _internalCharacterHits,
  ...
  /// <returns> Returns the number of hits </returns>
  public int
  CharacterCollisionsRaycast(Vector3 position, Vector3 direction,
    ...
    // Raycast
    int nbHits = 0;
    int nbUnfilteredHits =
        Physics.RaycastNonAlloc(position, direction, hits, distance,
