...
public class PlayableMover : MonoBehaviour, IMoverController {
  ...
  // This is called every FixedUpdate by our PhysicsMover in order to tell it
  // what pose it should go to
  public void UpdateMovement(out Vector3 goalPosition,
    ...
    // This is so that the real movement can be handled by the physics mover;
    // not the animation
