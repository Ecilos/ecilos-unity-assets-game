...
public class MyCharacterController : MonoBehaviour, ICharacterController {
  ...
  public void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime) {
    ...
    if (_jumpRequested) {
      ...
      if (!_jumpConsumed &&
          ((AllowJumpingWhenSliding ? Motor.GroundingStatus.FoundAnyGround
                                    : Motor.GroundingStatus.IsStableOnGround) ||
        ...
        // If this line weren't here, the character would remain snapped to the
        // ground when trying to jump. Try commenting this line out and see.
        Motor.ForceUnground(0.1f);
