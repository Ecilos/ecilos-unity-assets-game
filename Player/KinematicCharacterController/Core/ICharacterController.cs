...
public interface ICharacterController {
  ...
  /// <summary>
  /// This is called after the motor has finished its ground probing, but before
  /// PhysicsMover/Velocity/etc.... handling
  /// </summary>
  ...
  void OnMovementHit(Collider hitCollider, Vector3 hitNormal, Vector3 hitPoint,
                     ref HitStabilityReport hitStabilityReport);
  /// <summary>
  /// This is called after every move hit, to give you an opportunity to modify
  /// the HitStabilityReport to your liking
  /// </summary>
  void ProcessHitStabilityReport(Collider hitCollider, Vector3 hitNormal,
                                 ...
                                 ref HitStabilityReport hitStabilityReport);
  /// <summary>
  /// This is called when the character detects discrete collisions (collisions
  /// that don't result from the motor's capsuleCasts when moving)
  /// </summary>
