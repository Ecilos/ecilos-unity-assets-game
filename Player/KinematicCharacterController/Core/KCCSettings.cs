...
public class KCCSettings : ScriptableObject {
  ...
  /// Initial capacity of the system's list of Motors (will resize automatically
  /// if needed, but setting a high initial capacity can help preventing GC
  /// allocs)
  /// </summary>
  [Tooltip(
  ...
  /// <summary>
  /// Initial capacity of the system's list of Movers (will resize automatically
  /// if needed, but setting a high initial capacity can help preventing GC
  /// allocs)
  /// </summary>
  [Tooltip(
