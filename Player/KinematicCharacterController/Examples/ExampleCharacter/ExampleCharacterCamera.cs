...
public class ExampleCharacterCamera : MonoBehaviour {
  ...
  public void UpdateWithInput(float deltaTime, float zoomInput,
    ...
    if (FollowTransform) {
      ...
      Quaternion rotationFromInput = Quaternion.Euler(
          FollowTransform.up * (rotationInput.x * RotationSpeed));
      PlanarDirection = rotationFromInput * PlanarDirection;
      PlanarDirection =
          Vector3.Cross(FollowTransform.up,
                        Vector3.Cross(PlanarDirection, FollowTransform.up));
      Quaternion planarRot =
          Quaternion.LookRotation(PlanarDirection, FollowTransform.up);

      _targetVerticalAngle -= (rotationInput.y * RotationSpeed);
      _targetVerticalAngle =
          Mathf.Clamp(_targetVerticalAngle, MinVerticalAngle, MaxVerticalAngle);
      Quaternion verticalRot = Quaternion.Euler(_targetVerticalAngle, 0, 0);
      Quaternion targetRotation =
          Quaternion.Slerp(Transform.rotation, planarRot * verticalRot,
      ...
      _currentFollowPosition =
          Vector3.Lerp(_currentFollowPosition, FollowTransform.position,
      ...
      // Handle obstructions
      {
        ...
        _obstructionCount = Physics.SphereCastNonAlloc(
            ...
            _obstructions, TargetDistance, ObstructionLayers,
        ...
        if (closestHit.distance < Mathf.Infinity) {
          ...
          _currentDistance =
              Mathf.Lerp(_currentDistance, closestHit.distance,
        ...
        // If no obstruction
          ...
          _currentDistance =
              Mathf.Lerp(_currentDistance, TargetDistance,
