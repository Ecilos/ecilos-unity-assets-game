...
public class StressTestManager : MonoBehaviour {
  ...
  private void Update() {
    ...
    KinematicCharacterSystem.Simulate(Time.deltaTime,
  ...
  public void ToggleInterpolation() {
    KinematicCharacterSystem.Settings.Interpolate =
        !KinematicCharacterSystem.Settings.Interpolate;
    UpdateOnImages();
  }
  ...
  public void Spawn() {
    ...
    for (int i = 0; i < SpawnCount; i++) {
      ...
      Vector3 pos = firstPos + (Vector3.right * row * SpawnDistance) +
                    (Vector3.forward * col * SpawnDistance);
