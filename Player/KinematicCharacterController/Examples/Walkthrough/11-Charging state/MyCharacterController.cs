...
public class MyCharacterController : MonoBehaviour, ICharacterController {
  ...
  public void AfterCharacterUpdate(float deltaTime) {
    ...
    case CharacterState.Charging: {
      ...
      // Detect end of stopping phase and transition back to default movement
      // state
  ...
  public void OnMovementHit(Collider hitCollider, Vector3 hitNormal,
    ...
    case CharacterState.Charging: {
      ...
      if (!_isStopped && !hitStabilityReport.IsStable &&
          Vector3.Dot(-hitNormal, _currentChargeVelocity.normalized) > 0.5f) {
        _mustStopVelocity = true;
        _isStopped = true;
      }
      break;
