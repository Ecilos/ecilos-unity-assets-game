...
public class MyCharacterController : MonoBehaviour, ICharacterController {
  ...
  public void OnStateEnter(CharacterState state, CharacterState fromState) {
    ...
    case CharacterState.Climbing: {
      ...
      _ladderTargetPosition = _activeLadder.ClosestPointOnLadderSegment(
          Motor.TransientPosition, out _onLadderSegmentState);
    ...
    if (inputs.ClimbLadder) {
      if (Motor.CharacterOverlap(Motor.TransientPosition,
        ...
        if (_probedColliders[0] != null) {
          // Handle ladders
          MyLadder ladder =
              _probedColliders[0].gameObject.GetComponent<MyLadder>();
          if (ladder) {
  ...
  public void UpdateRotation(ref Quaternion currentRotation, float deltaTime) {
    ...
    case CharacterState.Climbing: {
      ...
      case ClimbingState.DeAnchoring:
        currentRotation =
            Quaternion.Slerp(_anchoringStartRotation, _ladderTargetRotation,
  ...
  public void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime) {
    ...
    case CharacterState.Climbing: {
      ...
      case ClimbingState.Climbing:
        currentVelocity =
            (_ladderUpDownInput * _activeLadder.transform.up).normalized *
            ClimbingSpeed;
        break;
      case ClimbingState.Anchoring:
      case ClimbingState.DeAnchoring:
        Vector3 tmpPosition =
            Vector3.Lerp(_anchoringStartPosition, _ladderTargetPosition,
                         (_anchoringTimer / AnchoringDuration));
        currentVelocity = Motor.GetVelocityForMovePosition(
            Motor.TransientPosition, tmpPosition, deltaTime);
        break;
      }
      break;
    }
